...
public class CC_Controller {
	// FXML buttons
		...
		private void calibrateCamera()
		{
			...
			intrinsic.put(1, 1, 1);
			// calibrate!
			System.out.println("objectPoints:" + objectPoints.get(0).toString());
			System.out.println("imagePoints:" + imagePoints.get(0).toString());
			for(int i = 0; i< 63; i++){
			...
			System.out.println("rvecs:" + rvecs.get(0).toString());
			System.out.println("tvecs:" + tvecs.get(0).toString());
